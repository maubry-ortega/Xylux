...
use xylux_ide::{Config, Editor, Error};
...
/// # Errors
///
/// Any error that occurs during the execution of the program will be returned by
/// this function.
fn main() -> Result<(), Error> {
    let mut args = std::env::args();
    match (args.nth(1), /* remaining_args= */ args.len()) {
        (Some(arg), 0) if arg == "--version" => println!("Xylux IDE {}", env!("CARGO_PKG_VERSION")),
